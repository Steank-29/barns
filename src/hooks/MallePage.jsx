...
const getValidImageUrl = (imageUrl) => {
  if (!imageUrl) return "/placeholder-malle.jpg";
...
export default function MallePage() {
  ...
  const activeItem = malles.find((item) => item._id === selectedId);
  const description =
          ...
          <ProductCard elevation={3}>
            ...
            <SelectionMenuBox>
              ...
              <FormControl size="small">
                <InputLabel
                  id="malle-select-label"
                  sx={{ color: "#38598b", fontFamily: "Savate" }}
                >
                  Malle
                </InputLabel>
                <Select
                  labelId="malle-select-label"
                  value={selectedId}
            ...
            <Box sx={{ flex: 1 }}>
              ...
              <Box sx={{ display: "flex", gap: 1, flexWrap: "wrap", my: 2 }}>
                ...
                {activeItem.thickness && (
                  <Chip label={`Épaisseur: ${activeItem.thickness}`} size="small" sx={{ backgroundColor: "grey.100", fontFamily: "Savate" }} />
                )}
              </Box>
