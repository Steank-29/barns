...
const getValidImageUrl = (imageUrl) => {
  if (!imageUrl) return "/placeholder-mang.jpg";
...
export default function MangPage() {
  ...
  const activeItem = mangs.find((item) => item._id === selectedId);
  const description =
  ...
  return (
    <Container maxWidth="lg" sx={{ py: 5 }}>
      ...
      >
        Notre Collection de Mangeoires
      </Typography>
          ...
          <ProductCard elevation={3}>
            ...
            <SelectionMenuBox>
              ...
              <FormControl size="small">
                <InputLabel
                  id="mang-select-label"
                  sx={{ color: "#38598b", fontFamily: "Savate" }}
                >
                  Mangeoire
                </InputLabel>
                <Select
                  labelId="mang-select-label"
                  value={selectedId}
