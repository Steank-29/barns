...
const getValidImageUrl = (imageUrl) => {
  if (!imageUrl) return "/placeholder-fivebox.jpg";
...
export default function FiveBoxPage() {
  ...
  const activeItem = fiveBoxes.find((item) => item._id === selectedId);
  const description =
          ...
          <ProductCard elevation={3}>
            ...
            <SelectionMenuBox>
              ...
              <FormControl size="small">
                <InputLabel
                  id="fivebox-select-label"
                  sx={{ color: "#38598b", fontFamily: "Savate" }}
                >
                  5 Box
                </InputLabel>
                <Select
                  labelId="fivebox-select-label"
                  value={selectedId}
