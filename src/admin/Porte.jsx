...
const Porte = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(`http://localhost:5000/api/porte`, formPayload, {
  ...
  return (
    <Box sx={{ 
      ...
      <Box sx={{ 
        ...
        >
          Création d'une Porte de la sellerie
        </Typography>
            ...
            <Grid container spacing={isMobile ? 1 : 2}>
              ...
              <Grid item xs={12} sm={6}>
                <StyledTextarea
                  ...
                  onChange={handleInputChange}
                  placeholder='Description de Porte...'
                />
              </Grid>
