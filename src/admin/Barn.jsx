...
const Barn = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(`http://localhost:5000/api/barn`, formPayload, {
  ...
  const formattedProductName = `${formData.productName || 'Nom du produit'}  `;
