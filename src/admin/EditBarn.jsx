...
const EditBarn = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const response = await fetch('http://localhost:5000/api/barn/getallbarns');
        if (!response.ok) {
  ...
  const confirmDelete = async () => {
    try {
      const response = await fetch(`http://localhost:5000/api/barn/deletebarn/${productToDelete.reference}`, {
        method: 'DELETE'
      });
  ...
  return (
    <div style={{ padding: isMobile ? '10px' : '20px' }}>
      <Typography variant={isMobile ? 'h5' : 'h4'} gutterBottom sx={{ 
        ...
        Barns Management – Solutions Intelligentes de Gestion et de Suivi
      </Typography>
                    ...
                    <Box sx={{
                      ...
                      <Box sx={{ '& > *': { mb: 1.5 } }}>
                        ...
                        <Box display="flex">
                          ...
                          <Typography variant="body1" sx={{ fontSize: isMobile ? '0.9rem' : '1rem' }}>
                            {selectedProduct.width || 'N/A'}m (H) × {selectedProduct.height || 'N/A'}m (L) 
                          </Typography>
                        </Box>
        ...
        <DialogTitle sx={{ 
          ...
          <Box display="flex" justifyContent="space-between" alignItems="center">
            <Box display="flex" alignItems="center">
              ...
              Gérer et Modifier les Détails de Barn
              </Typography>
            </Box>
            <IconButton 
              onClick={closeDialog} 
