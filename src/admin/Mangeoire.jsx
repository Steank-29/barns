...
const Mangeoire = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(`http://localhost:5000/api/mang`, formPayload, {
  ...
  return (
    <Box sx={{ 
      ...
      <Box sx={{ 
        ...
        >
          Création d'une Mangeoire de la sellerie
        </Typography>
            ...
            <Grid container spacing={isMobile ? 1 : 2}>
              ...
              <Grid item xs={12} sm={6}>
                <StyledTextarea
                  ...
                  onChange={handleInputChange}
                  placeholder='Description de Mangeoire...'
                />
              </Grid>
